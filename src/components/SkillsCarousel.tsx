      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-6">
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full text-sm font-bold shadow-lg animate-pulse">
              💪 Skills & Expertise
            </span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Mastering the tools that bring creative visions to life with precision and innovation
          </p>
        </div>
        ...
        <div className="relative overflow-hidden">
          <div 
            ...
            style={{
              ...
              width: `${(extendedSkills.length * 100) / 3}%`
            }}
          >
            {extendedSkills.map((skill, index) => (
              <div
                ...
                style={{ width: `${100 / extendedSkills.length}%` }}
              >
